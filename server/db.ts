...
// Initial Bihar Districts (All 38 Districts)
const initialDistricts: BiharDistrict[] = [
  {
    id: 'dist-araria',
    name: 'Araria',
    headquarters: 'Araria',
    popularAreas: ['Zero Mile', 'Forbesganj', 'Raniganj', 'Jokihat'],
    pincodes: ['854311', '854318'],
    activeMentorsCount: 6,
  },
  {
    id: 'dist-arwal',
    name: 'Arwal',
    ...
    pincodes: ['804401'],
    activeMentorsCount: 5,
  },
  {
    id: 'dist-aurangabad',
    name: 'Aurangabad',
    headquarters: 'Aurangabad',
    popularAreas: ['Ramesh Chowk', 'MG Road', 'Daudnagar', 'Obra', 'Rafiganj'],
    pincodes: ['824101', '824143'],
  ...
  },
  {
    ...
    popularAreas: ['Adampur', 'Tilkamanjhi', 'Zero Mile', 'Khanjarpur', 'Barari', 'Naugachia'],
    pincodes: ['812001', '812002', '853204'],
  ...
  },
  {
    ...
    popularAreas: ['Bara Bazar', 'Ganga Sagar', 'Jhanjharpur', 'Benipatti', 'Pandaul'],
    pincodes: ['847211', '847404'],
    activeMentorsCount: 15,
  },
  {
    id: 'dist-munger',
  ...
  },
  {
    ...
    popularAreas: ['Mithanpura', 'Club Road', 'Kalambagh Chowk', 'Brahmpura', 'Juran Chapra', 'Ahiyapur'],
    pincodes: ['842001', '842002', '842003'],
    activeMentorsCount: 30,
  },
  {
    id: 'dist-nalanda',
    name: 'Nalanda (Bihar Sharif)',
    headquarters: 'Bihar Sharif',
    popularAreas: ['Ranchi Road', 'Khandak Par', 'Rajgir', 'Hilsa', 'Asthawan'],
  ...
  },
  {
    ...
    name: 'Patna',
    headquarters: 'Patna',
    popularAreas: ['Kankarbagh', 'Boring Road', 'Rajendra Nagar', 'Bailey Road', 'Patliputra', 'Anisabad', 'Danapur'],
    pincodes: ['800020', '800001', '800013', '800023', '801503'],
    activeMentorsCount: 55,
  },
  {
    id: 'dist-purnia',
    name: 'Purnia',
  ...
  },
  {
    ...
    popularAreas: ['Fazal Ganj', 'GT Road', 'Dehri On Sone', 'Nokha', 'Bikramganj'],
  ...
  },
  {
    ...
    popularAreas: ['Dak Bungalow Road', 'Municipality Chowk', 'Sonpur', 'Marhaura', 'Garkha'],
    pincodes: ['841301', '841101'],
    activeMentorsCount: 15,
  },
  {
    id: 'dist-sheikhpura',
  ...
  },
  {
    ...
    popularAreas: ['Dumra Road', 'Mehsaul Chowk', 'Bairgania', 'Pupri', 'Sursand'],
    pincodes: ['843302', '843320'],
    activeMentorsCount: 12,
  },
  {
    id: 'dist-siwan',
    name: 'Siwan',
    headquarters: 'Siwan',
    popularAreas: ['Babunia Road', 'Hospital Mor', 'Mairwa', 'Maharajganj', 'Barharia'],
    pincodes: ['841226', '841238'],
    activeMentorsCount: 14,
  },
  {
    id: 'dist-supaul',
    name: 'Supaul',
    headquarters: 'Supaul',
    popularAreas: ['Station Road', 'Gandhi Maidan', 'Triveniganj', 'Birpur', 'Nirmali'],
    pincodes: ['852131', '852139'],
    activeMentorsCount: 9,
  },
  {
    id: 'dist-vaishali',
    ...
    popularAreas: ['Cinema Road', 'Anwarpur Chowk', 'Lalganj', 'Mahuwa', 'Bidupur'],
    pincodes: ['844101', '844121'],
  ...
  },
  {
    ...
    popularAreas: ['Lal Bazar', 'Station Chowk', 'Bagaha', 'Narkatiaganj', 'Chanpatia'],
    pincodes: ['845438', '845105'],
    activeMentorsCount: 15,
  },
];
...
export function createSeedData(): Database {
  ...
  // 1. Admin User (Strictly Single Authorized Administrator)
  const adminId = 'user-admin';
  const adminPwd = hashPassword('6287919120@DHARMRAJ');
  db.users.push({
    id: adminId,
    email: 'kdharmraj778@gmail.com',
    role: 'ADMIN',
    name: 'Dharmraj (Director & Admin)',
    mobile: '6287919120',
    city: 'Patna',
    district: 'Patna',
    state: 'Bihar',
