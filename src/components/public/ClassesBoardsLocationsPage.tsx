      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <div className="flex flex-wrap justify-center gap-2 pt-4">
            {[
              { id: 'classes', label: 'Classes (Nur - 10th)' },
              ...
              {[
                {
                  ...
                  focus: 'खेल-खेल में शिक्षा, अक्षरों और अंकों की पहचान (Phonics & Numeracy), सुंदर लिखावट की नींव, कविताएं और मौखिक संवाद कौशल।',
                ...
                <div key={c.classes} className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-3">
                  ...
                  <button
                    onClick={() => onNavigate('find-mentor', { classGrade: c.classes.startsWith('Nursery') ? 'Nursery' : c.classes.split(' ')[1] ? `Class ${c.classes.split(' ')[1].split('-')[0]}` : c.classes })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white rounded-2xl border border-blue-200 shadow-sm space-y-4">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Bihar School Examination Board (Matric Class 10 & Middle/Primary Foundation).
                </p>
              ...
              <div className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-4">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Central Board of Secondary Education (Nursery to Class 10).
                </p>
                <div className="space-y-2 text-xs text-slate-700">
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              ...
              <div className="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-4">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  Council for the Indian School Certificate Examinations (Nursery to Class 10 ICSE).
                </p>
                <div className="space-y-2 text-xs text-slate-700">
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
        ...
        {tab === 'locations' && (
          <div className="space-y-6 text-left">
            ...
            {/* All 38 Bihar Districts Grid Directory */}
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 pb-3 border-b border-slate-100">
                <div>
                  <h3 className="text-lg font-black text-slate-900">
                    All 38 Bihar Districts Network
                  </h3>
                  <p className="text-xs text-slate-500">
                    BBA Mentors operates across all 38 administrative districts of Bihar for verified home & online tuitions.
                  </p>
                </div>
                <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 font-black text-xs self-start sm:self-auto">
                  38 / 38 Districts Active
                </span>
              </div>
