            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 space-y-4">
                <div className="p-5 bg-white rounded-xl border border-slate-200 space-y-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed">
                    BBA Mentors Academic Center, 3rd Floor, Boring Canal Road / Bailey Road Intersection, Patna, Bihar - 800001
                  </p>
                </div>
                ...
                <div className="p-5 bg-white rounded-xl border border-slate-200 space-y-2">
                  ...
                  <p className="text-xs text-slate-600">support@bbamentors.com</p>
                  <p className="text-xs text-slate-600">admissions@bbamentors.com</p>
                </div>
              </div>
